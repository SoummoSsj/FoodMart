...
import com.example.project.Activity.SearchResultsActivity;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.categoryPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(holder.itemView.getContext(), SearchResultsActivity.class);

                intent.putExtra("searchText",categoryDomains.get(position).getTitle());
