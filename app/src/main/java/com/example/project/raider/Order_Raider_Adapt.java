...
public class Order_Raider_Adapt extends RecyclerView.Adapter<Order_Raider_Adapt.ViewHolder> {
    private List<FoodDomain> dataList;

    public Order_Raider_Adapt(List<FoodDomain> dataList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_r, parent, false);
